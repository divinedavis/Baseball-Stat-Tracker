...
COPY = {
    "promotionalText": (
        "Find the sweet spot. Log every at-bat in one tap — AVG, OBP, SLG, OPS "
        "live as you play. No account, no cloud, no noise. Built for the dugout."
    ),
    "description": (
        "BARREL is the fastest way to capture a real-game at-bat. Tap once — "
        "the stats update instantly.\n\n"
        ...
        "PRIVACY FIRST\n"
        "BARREL does not collect your data. No analytics. No tracking. Your roster, at-bats, "
    ...
    "keywords": "barrel,baseball,stats,tracker,at-bat,batting,average,coach,softball,ops,slg,obp,scorebook",
